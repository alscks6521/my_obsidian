...
// ── 이 대시보드 고유 키 (다른 Dash 파일과 겹치지 않게 변경하세요) ──
const STORAGE_KEY_REC  = "dashboard2_calRecords";
const STORAGE_KEY_MEMO = "dashboard2_memo";
try {
...
// ── 하위 페이지 목록 ──────────────────────────────────
const STORAGE_KEY_PAGES = "dashboard2_subpages";
let subPages = [];
try {
